			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<input type="hidden" name="action" value="SEARCH"/>
						<input style="margin-bottom:20px;width:220px;" type="text" name="searchvalue" placeholder="Search.." name="search">
						<button type="submit">
					...
					<div class="col-md-9">
						<%
							for (BookPost post : bookpost.getBookpostList(1)) {
						%>
						...
						<%
							for (MaterialPost mpost : matrialpost.getMatrialpostList(1)) {
						%>
