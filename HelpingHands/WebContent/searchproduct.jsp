...
<div class="wrapper">
	...
	<br />
	<%
		String getValue = request.getParameter("getsearchValue");
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-9">
						<%
							for (BookPost post : bookpost.searchBookpost(getValue)) {
						%>
						...
						<%
							for (MaterialPost mpost : matrialpost.searchMaterialpost(getValue)) {
						%>
