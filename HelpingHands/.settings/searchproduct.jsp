...
<div class="wrapper">
	...
	<br />
	<%
		String getid = request.getParameter("getsearchValue");
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-9">
						<%
							for (BookPost post : bookpost.searchBookpost(getid)) {
						%>
						...
						<%
							for (MaterialPost mpost : matrialpost.searchMaterialpost(getid)) {
						%>
